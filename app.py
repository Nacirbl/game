...
# Share one store instance with the game routes.
routes_game.store = store
...
async def lifespan(app: FastAPI):
    ...
    for directory in ("quizzes", "uploads", "results"):
...
async def home(request: Request, quiz: str | None = None):
    return templates.TemplateResponse(
        request=request,
        name="index.html",
        context={
            "request": request,
            # str|None only — rendering Python None here once showed
            # "None" in JS and broke the home page.
